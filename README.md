...
|---|---|---|
| Serving Framework | TTFT picks up $t_{\text{sched}} + t_{\text{tok}} + t_{\text{detok}}$; TPOT picks up $t_{\text{graph}} + t_{\text{sample}}$ — per-request terms land in TTFT, per-step terms land in TPOT | [`framework.md`](documentation/modeling/framework.md) |
